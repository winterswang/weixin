...
class faceTools {
	...
	public function __construct()
	{
    	...
    	$this->auth_params = array();
   		$this->auth_params['api_key'] = '80794efcf1c350268dc976b8fedd5617';
   		$this->auth_params['api_secret'] = 'E2GkxairkHBryPMvFQ35uRwnEpNembgR';
	}
	...
	{
		return $this->call("recognition/identify", array("url" => $url,"group_name" => $group_name));
	}
    ...
    {
        return $this->post_call("detection/detect", array("img" => '@'.$filename));
    }	
	//////////////////////////////////////////////////////////
	// private mathods
	//////////////////////////////////////////////////////////
